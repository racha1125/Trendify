...
function EditProductPage() {
    const [productData, setProductData] = useState({
        ...
        images:[
            {
                url: "https://picsum.photos/id/190/150/150",
            },
            {
                url: "https://picsum.photos/id/200/150/150",
            },
        ],
    });
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 shadow-md rounded-md">
        ...
        <form action="" onSubmit={handleSubmit}>
            ...
            {/* Image Upload */}
            <div className='mb-6'>
                <label htmlFor="" className='block font-semibold mb-2'>Upload Images</label>
                <input type="file" className="file:mr-4 file:py-1 file:px-4 file:border file:border-gray-300 file:rounded-md file:text-sm file:bg-white file:text-gray-700 hover:file:bg-gray-100" onChange={handleImageChange} />
